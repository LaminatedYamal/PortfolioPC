    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 md:p-6 pb-safe">
      <div className="max-w-4xl mx-auto bg-surface/90 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex-1">
          <h3 className="font-heading font-semibold text-lg text-white mb-2">{t.cookie.title}</h3>
        ...
        <div className="flex gap-3 shrink-0">
          ...
          <button 
            ...
            className="px-5 py-2.5 rounded-full text-sm font-medium bg-accent-indigo text-white hover:bg-accent-indigo/90 transition-colors shadow-sm"
          >
            {t.cookie.btnAccept}
          </button>
        </div>
