...
const ALL_PROJECTS: Project[] = [
  ...
  { _id: '6', title: 'SEO Audit & Competitor Report', category: 'SEO & SEM', overview: 'A detailed technical and competitor audit report designed to scale organic reach by identifying indexing blockers and high-value keyword opportunities.', skillsAcquired: ['Technical Auditing', 'On-page Optimization', 'Competitor Intelligence'], toolStack: ['Semrush', 'Screaming Frog', 'Search Console'], mediaType: 'pdf', mediaUrl: './sample-report.pdf' }
];
